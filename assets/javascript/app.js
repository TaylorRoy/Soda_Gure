...
$(document).ready(function () {
	...
	//creating callback function so my geolocation loads
		...
		$.ajax({
			...
			.then(function (response) {
				...
				for (var i = 0; i < 5; i++) {
					...
					//creating an link in sodaform.html below each gas station syrup list that links to the individual data for each location using location id
					var editButton = $("<a>");
					...
					// let isCool = 1 > 2 ? 'what to do if expression is truthy' : 'what to do if expression is falsey'
